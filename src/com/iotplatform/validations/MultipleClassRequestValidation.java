...
//
/// *
// * MultipleClassRequestValidation class is used to validate multiple Class
// request
...
//
// @Autowired
// public MultipleClassRequestValidation(ValidationDao validationDao,
...
// * performance
// */
// public Hashtable<String, DynamicConceptModel> getDynamicProperties(String
// applicationName,
...
// .add(new SqlCondition(DynamicConceptColumns.CLASS_URI.toString(),
// subjectClass.getUri()));
//
...
// try {
// res = dynamicConceptDao.getConceptsOfApplicationByFilters(applicationName,
// null, orCondtionsFilterList);
...
//
// Class subjectClass =
// htblAllStaticClasses.get(dynamicProperty.getClass_uri());
//
// // skip if the property was cached before
// if
// (subjectClass.getProperties().contains(dynamicProperty.getProperty_name())) {
// continue;
// }
...
// {
// subjectClass.getProperties().put(dynamicProperty.getProperty_name(), new
// ObjectProperty(
// dynamicProperty.getProperty_name(),
// getPrefix(dynamicProperty.getProperty_prefix_alias()),
...
// Hashtable<Class, Hashtable<String, PropertyValue>> htblClassFieldValue, Class
// requestSubjectClass) {
//
...
//
// Iterator<Class> htblPropertyValueIterator =
// htblClassFieldValue.keySet().iterator();
//
// while (htblPropertyValueIterator.hasNext()) {
// Class subjectClass = htblPropertyValueIterator.next();
// Hashtable<String, PropertyValue> htblFieldValue =
// htblClassFieldValue.get(subjectClass);
//
// /*
...
// constructPropertyValue(property, valueType.getValue(), subjectClass,
// valueType.isObject()));
//
// }
// }
...
// throw new InvalidRequestFieldsException(requestSubjectClass.getName(),
// field);
// } else {
//
// /*
...
//
// Class subjectClass =
// htblAllStaticClasses.get(loadedDynamicProperties.get(field).getClass_uri());
...
//
// returnedPropertyValueList
// .addAll(constructPropertyValue(property,
// htblNotFoundFieldValue.get(field).getValue(),
...
// * and properties
// */
// private ArrayList<PropertyValue> constructPropertyValue(Property property,
// Object value, Class subjectClass,
// boolean isObject) {
//
// ArrayList<PropertyValue> propValueList = new ArrayList<>();
//
// String prefixedProperty = property.getPrefix().getPrefix() +
// property.getName();
// /*
...
// PropertyValue propertyValue = new PropertyValue(prefixedProperty,
// prefixedValue, isObject);
...
// * occured
// */
// private boolean isObjectPropertiesValuesValid(ArrayList<PropertyValue>
...
// htblAllStaticClasses.put("http://iot-platform#Application", new
// Application());
...
// new Attribute());
// htblAllStaticClasses.put("http://iot-platform#CommunicatingDevice", new
// CommunicatingDevice());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Condition", new
// Condition());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/UNIS/fiware/iot-lite#Coverage",
// new Coverage());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Deployment", new
// Deployment());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#DeploymentRelatedProcess",
// new DeploymentRelatedProcess());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Device", new
// Device());
// htblAllStaticClasses.put("http://iot-platform#DeviceModule", new
// DeviceModule());
...
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Input", new
// Input());
...
// new ObjectClass());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Observation", new
// Observation());
...
// new OperatingProperty());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#OperatingRange",
// new OperatingRange());
// htblAllStaticClasses.put("http://xmlns.com/foaf/0.1/Organization", new
// Organization());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Output", new
// Output());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Platform", new
// Platform());
// htblAllStaticClasses.put("http://www.w3.org/2003/01/geo/wgs84_pos#Point", new
// Point());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Process", new
// Process());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Property",
// new com.iotplatform.ontology.classes.Property());
// htblAllStaticClasses.put("http://purl.org/NET/ssnx/qu/qu#QuantityKind", new
// QuantityKind());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Sensing", new
// Sensing());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#SensingDevice",
// new SensingDevice());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Sensor", new
// Sensor());
...
// new Service());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#Stimulus", new
// Stimulus());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#SurvivalProperty",
// new SurvivalProperty());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#SurvivalRange",
// new SurvivalRange());
// htblAllStaticClasses.put("http://purl.oclc.org/NET/ssnx/ssn#System", new
// SystemClass());
...
// ValidationDao validationDao = new ValidationDao(new Oracle(szJdbcURL, szUser,
// szPasswd));
//
...
//
// Hashtable<Class, Hashtable<String, PropertyValue>> htblClassFieldValue = new
// Hashtable<>();
//
...
// htblDeveloperPropValues.put("knows", new PropertyValue("HatemMorgan",
// false));
...
//
// Hashtable<String, PropertyValue> htblActuatingDevicePropValues = new
// Hashtable<>();
// htblActuatingDevicePropValues.put("hasOperatingRange", new
// PropertyValue("90129-219301-219031", false));
// htblActuatingDevicePropValues.put("test", new
// PropertyValue("2134-2313-242-33332", false));
//
